...
@section('content')
    <div class="col-lg-9 col-sm-12">
        ...
        <h3>Reminder: {{$reminder->name}}</h3>
        <hr>
        <p>Type information about '{{$reminder->name}}'</p>
        <form action="{{ url('car/'.$car->id . '/reminder/' . $reminder->id . '/add/record') }}" method="POST" class="form-horizontal">
            {{ csrf_field() }}
            <div class="row">
